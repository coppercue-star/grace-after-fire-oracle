...
import { Heart, Lock, Sparkles, BookOpen, Flame, Bell, BellOff, X, ChevronRight, Mail, LogOut, ShieldCheck } from "lucide-react";
    ...
    <div style={styles.app}>
      ...
      <div style={styles.contentCol}>
        ...
        <main style={styles.main}>
          ...
          {view === "journal" && (
            <JournalView journal={journal} cards={CARDS} session={session} onLogin={() => setShowLogin(true)} />
          )}
        </main>
      </div>
...
function JournalView({ journal, cards, session, onLogin }) {
  if (!session?.user) {
    return (
...
const styles = {
  loadingWrap: { height: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#F8F1E9" },
  app: {
    minHeight: "100vh",
    maxWidth: 480,
    margin: "0 auto",
    background: "linear-gradient(180deg, #FBF6F0 0%, #F5E9DD 45%, #EEDCCB 100%)",
  ...
  contentCol: {
    display: "flex", flexDirection: "column", flex: 1, minWidth: 0, position: "relative",
  },
  ...
  streakPill: {
    ...
    border: "1px solid rgba(200,149,80,0.35)", borderRadius: 999,
  ...
  cardBack: {
    ...
    boxShadow: "0 24px 48px -16px rgba(61,21,38,0.55), inset 0 1px 0 rgba(200,149,80,0.25)",
    display: "flex", alignItems: "center", justifyContent: "center",
    border: "1px solid rgba(200,149,80,0.3)",
  },
  cardBackInner: { display: "flex", flexDirection: "column", alignItems: "center", gap: 16, textAlign: "center" },
  cardBackText: { color: "#F0D9A8", fontSize: 14, fontWeight: 500, lineHeight: 1.5, letterSpacing: 0.1 },
  emptyHint: { marginTop: 24, fontSize: 13.5, color: "#8A6448", textAlign: "center", maxWidth: 250, lineHeight: 1.55 },
  ...
  cardFaceBack: {
    ...
    boxShadow: "0 24px 48px -16px rgba(61,21,38,0.55)",
    border: "1px solid rgba(200,149,80,0.3)",
  },
  cardFaceFront: {
    position: "absolute", inset: 0, borderRadius: 22, padding: "30px 26px",
    background: "#FFFCF6", transform: "rotateY(180deg)", backfaceVisibility: "hidden",
    boxShadow: "0 24px 48px -16px rgba(90,60,30,0.28)",
    border: "1px solid #EDDCC0",
    display: "flex", flexDirection: "column", gap: 16, overflowY: "auto",
  },
  cardTheme: { fontSize: 10.5, letterSpacing: 1.6, textTransform: "uppercase", color: "#A8763A", fontWeight: 700 },
  cardTitle: { fontFamily: "'Fraunces', serif", fontSize: 24, fontWeight: 600, color: "#2E1B26", lineHeight: 1.2, letterSpacing: -0.3 },
  cardMessage: { fontSize: 14.5, lineHeight: 1.65, color: "#4A3230" },
  cardAffirmation: { marginTop: "auto", fontSize: 13.5, fontStyle: "italic", fontFamily: "'Fraunces', serif", color: "#8C6220", borderTop: "1px solid #EDDCC0", paddingTop: 15 },

  noteBox: { width: 264, marginTop: 24 },
  noteLabel: { fontSize: 12.5, color: "#6E4A20", marginBottom: 8, fontWeight: 600 },
  noteInput: {
    width: "100%", borderRadius: 16, border: "1px solid #E8D4B0", padding: 13,
    fontFamily: "'Inter', sans-serif", fontSize: 13.5, color: "#2E1B26", resize: "none",
  ...
  saveBtn: {
    ...
    background: "linear-gradient(135deg, #C89550, #A8763A)", color: "#2E1B26", fontWeight: 700, fontSize: 13.5, cursor: "pointer",
    fontFamily: "'Inter', sans-serif", boxShadow: "0 8px 20px -8px rgba(168,118,58,0.5)",
  },
  drawAgainBtn: {
    marginTop: 16, background: "none", border: "none", color: "#7D2E45",
  ...
  deckIntroTitle: { fontFamily: "'Fraunces', serif", fontSize: 22, fontWeight: 600, color: "#2E1B26", letterSpacing: -0.3 },
  deckIntroSub: { fontSize: 12.5, color: "#8A6448", marginTop: 5 },
  themeGroup: { marginBottom: 24 },
  themeLabel: { fontSize: 11, letterSpacing: 1.1, textTransform: "uppercase", color: "#A8763A", fontWeight: 700, marginBottom: 11 },
  themeGrid: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 },
  deckCard: {
    position: "relative", background: "rgba(255,255,255,0.65)", backdropFilter: "blur(6px)",
    border: "1px solid rgba(200,149,80,0.25)",
    borderRadius: 16, padding: "15px 13px", cursor: "pointer", minHeight: 58,
    display: "flex", alignItems: "center", boxShadow: "0 6px 16px -10px rgba(90,60,30,0.2)",
  },
  deckCardTitle: { fontSize: 12.5, color: "#4A3230", fontWeight: 500, lineHeight: 1.35 },
  lockBadge: {
    position: "absolute", top: 9, right: 9, background: "linear-gradient(135deg, #C89550, #A8763A)", color: "#2E1B26",
  ...
  journalEntryTitle: { fontFamily: "'Fraunces', serif", fontWeight: 600, fontSize: 16, color: "#2E1B26" },
  journalEntryDate: { fontSize: 11, color: "#A8763A", fontWeight: 600 },
  journalEntryNote: { fontSize: 13, color: "#4A3230", lineHeight: 1.5 },

  nav: {
    width: 76, flexShrink: 0, minHeight: "100vh",
  ...
  toastInner: {
    background: "#2E1B26", color: "#F0D9A8", borderRadius: 18, padding: "15px 19px",
    boxShadow: "0 18px 36px -12px rgba(46,27,38,0.5)",
  },
  toastTitle: { fontSize: 11, letterSpacing: 1, textTransform: "uppercase", opacity: 0.8, marginBottom: 4, fontWeight: 600, color: "#C89550" },
  ...
  modalOverlay: {
    position: "fixed", inset: 0, background: "rgba(46,27,38,0.5)", backdropFilter: "blur(4px)", display: "flex",
    alignItems: "center", justifyContent: "center", zIndex: 100, padding: 24,
  },
  modalCard: {
    background: "#FFFCF6", borderRadius: 26, padding: "30px 26px", maxWidth: 340, width: "100%",
    position: "relative", textAlign: "center", boxShadow: "0 30px 70px -14px rgba(46,27,38,0.45)",
  },
  modalClose: { position: "absolute", top: 16, right: 16, background: "none", border: "none", color: "#B08A5A", cursor: "pointer" },
  modalTitle: { fontFamily: "'Fraunces', serif", fontSize: 22, fontWeight: 600, color: "#2E1B26", marginTop: 12, letterSpacing: -0.3 },
  modalBody: { fontSize: 13.5, color: "#4A3230", lineHeight: 1.6, marginTop: 11 },
  modalPriceRow: { marginTop: 18 },
  modalPrice: { fontFamily: "'Fraunces', serif", fontSize: 32, fontWeight: 600, color: "#2E1B26" },
  modalPriceSub: { fontSize: 13, fontWeight: 400, color: "#8A6448" },
  modalCta: {
    marginTop: 18, width: "100%", padding: "14px 0", borderRadius: 999, border: "none",
    background: "linear-gradient(135deg, #C89550, #A8763A)", color: "#2E1B26", fontWeight: 700, fontSize: 14, cursor: "pointer",
    display: "flex", alignItems: "center", justifyContent: "center", gap: 4,
    fontFamily: "'Inter', sans-serif", boxShadow: "0 10px 24px -10px rgba(168,118,58,0.55)",
  },
  modalDismiss: { marginTop: 12, background: "none", border: "none", color: "#8A6448", fontSize: 12.5, cursor: "pointer" },
};
